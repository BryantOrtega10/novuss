...
@section('contenido')
    ...
    <div class="cajaGeneral">
        ...
        <form action="/novedades/modificarNovedadOtros" method="POST" class="formGeneral" id="formDatosNovedad" autocomplete="off">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-group hasText">
                        ...
                        <input type="text" class="form-control separadorMiles" id="valor" name="valor" value="{{$otra_novedad->valor}}" />
                    </div>
                </div>
                <div class="col-3">
                    <div class="form-group hasText">
                        ...
                        <select class="form-control" id="sumaResta" name="sumaResta">
                            <option value=""></option>
                            <option value="1" @if($otra_novedad->sumaResta == "1") selected @endif>Suma</option>
                            <option value="-1" @if($otra_novedad->sumaResta == "-1") selected @endif>Resta</option>
                        </select>
                    </div>
                </div>  
            </div>
