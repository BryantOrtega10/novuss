...
@section('contenido')
    ...
    <div class="cajaGeneral">
        ...
        <form action="/novedades/modificarNovedadHoraExtra2" method="POST" class="formGeneral" id="formDatosNovedad" autocomplete="off">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-group hasText">
                        ...
                        <input type="text" class="form-control" id="cantidadHoras" name="cantidadHoras" value="{{$horas_extra->cantidadHoras }}"/>
                    </div>
                </div>
            </div>
