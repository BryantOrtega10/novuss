...
@section('contenido')
    ...
    <div class="cajaGeneral">
        ...
        <form action="/novedades/modificarNovedadHoraExtra1" method="POST" class="formGeneral" id="formDatosNovedad" autocomplete="off">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-group hasText">
                        ...
                        <input type="datetime-local" class="form-control" id="horaInicial" name="horaInicial"  value="{{date("Y-m-d",strtotime($horas_extra->fechaHoraInicial))."T".date("H:i:s",strtotime($horas_extra->fechaHoraInicial))}}" />
                    </div>
                </div>
                <div class="col-3">
                    <div class="form-group hasText">
                        <label for="horaFinal" class="control-label">Hora Final:</label>
                        <input type="datetime-local" class="form-control" id="horaFinal" name="horaFinal"  value="{{date("Y-m-d",strtotime($horas_extra->fechaHoraFinal))."T".date("H:i:s",strtotime($horas_extra->fechaHoraFinal))}}" />
                    </div>
                </div>
            </div>
