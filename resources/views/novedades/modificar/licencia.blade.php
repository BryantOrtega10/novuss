            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-group hasText">
                        ...
                        <input type="date" class="form-control" id="fechaInicial" name="fechaInicial" value="{{$licencia->fechaInicial}}" />
                    </div>
                </div>
                <div class="col-3">
                    <div class="form-group hasText">
                        <label for="dias" class="control-label">Dias:</label>
                        <input type="text" class="form-control" id="dias" name="dias" value="{{$licencia->numDias}}" />
                    </div>
                </div>
            </div>
            <div class="row">
