...
<form action="/novedades/insertarNovedadHoraTipo1" method="POST" class="formGeneral" id="formDatosNovedad" autocomplete="off">
    @csrf
    ...
    @include('novedades.ajaxAdicional.horas1', [
        'idRow' => $idRow,
        'conceptos' => $conceptos,
        'req' => $req
    ])
