<div class="novedadAdicional" data-id="{{$idRow}}">
    ...
    <div class="row">
        ...
        <div class="col-3">
            <div class="form-group">
                <label for="valor{{$idRow}}" class="control-label">Valor:</label>
                <input type="text" class="form-control separadorMiles" id="valor{{$idRow}}" name="valor[]" />
            </div>
        </div>
        <div class="col-3">
            <div class="form-group hasText">
                <label for="sumaResta{{$idRow}}" class="control-label">Operacion:</label>
                <select class="form-control" id="sumaResta{{$idRow}}" name="sumaResta[]">
                    <option value=""></option>
