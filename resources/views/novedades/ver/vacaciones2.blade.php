            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-group hasText">
                        ...
                        <input type="date" class="form-control"  readonly id="fecha" name="fecha" value="{{$novedad->fechaRegistro}}"/>
                    </div>
                </div>
                <div class="col-3">
                    <div class="form-group hasText">
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-group hasText">
                        ...
                        <input type="text" class="form-control" id="diasVacac" readonly name="dias" value="{{$vacaciones->diasCompensar}}"/>
                    </div>
                </div>
