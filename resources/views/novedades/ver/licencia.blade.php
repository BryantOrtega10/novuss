...
@section('contenido')
    ...
    <div class="cajaGeneral">
        ...
        <form action="/novedades/modificarNovedadLicencia" method="POST" class="formGeneral" id="formDatosNovedad" autocomplete="off">
            @csrf
            <input type="hidden" name="fkTipoNovedad" value="{{$novedad->fkTipoNovedad }}" />
            <input type="hidden" name="idNovedad" value="{{$novedad->idNovedad }}" />
            <input type="hidden" name="idLicencia" value="{{$novedad->fkLicencia }}" />
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-group hasText">
                        ...
                        <input type="date" class="form-control" id="fechaInicial" name="fechaInicial" readonly value="{{$licencia->fechaInicial}}" />
                    </div>
                </div>
                <div class="col-3">
                    <div class="form-group hasText">
                        <label for="dias" class="control-label">Dias:</label>
                        <input type="text" class="form-control" id="dias" name="dias" readonly value="{{$licencia->numDias}}" />
                    </div>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-group hasText">
                        ...
                        <input type="date" class="form-control" id="fechaFinal" name="fechaFinal" readonly value="{{$licencia->fechaFinal}}"/>
                    </div>
                </div>
            </div>
