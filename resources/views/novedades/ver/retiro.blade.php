...
@section('contenido')
    ...
    <div class="cajaGeneral">
        ...
        <form action="/" method="POST" class="formGeneral" id="formDatosNovedad" autocomplete="off">
            ...
            <div class="row">
                <div class="col-3">
                    <div class="form-group hasText" id="">
                ...
                <div class="col-3">
                    <div class="form-group hasText">
                        ...
                        <input type="date" class="form-control" id="fechaRetiro" readonly name="fechaRetiro" value="{{$retiro->fecha}}" />
                    </div>
                </div>
                <div class="col-3">
                    <div class="form-group hasText">
                        <label for="fechaRetiroReal" class="control-label">Fecha Real:</label>
                        <input type="date" class="form-control" id="fechaRetiroReal" readonly name="fechaRetiroReal" value="{{$retiro->fechaReal}}" />
                    </div>
                </div>
                <div class="col-3">
                    <div class="form-group hasText">
                        ...
                        @foreach ($motivosRetiro as $motivoRetiro)
                            @if($motivoRetiro->idMotivoRetiro == $retiro->fkMotivoRetiro)
                                <input type="text" id="motivoRetiro" readonly value="{{$motivoRetiro->nombre}}" />
                            @endif
                        @endforeach
                    </div>
                </div>
