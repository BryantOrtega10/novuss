...
@section('contenido')
    ...
    <div class="cajaGeneral">
        ...
        <form action="" method="POST" class="formGeneral" id="formDatosNovedad" autocomplete="off">
            ...
            <input type="hidden" name="idAusencia" value="{{$novedad->fkAusencia }}" />
            ...
            <div class="row">
                ...
                <div class="col-3">
                    <div class="form-group hasText">
                        ...
                        <input type="date" class="form-control" id="fechaAusenciaInicial" readonly name="fechaAusenciaInicial" value="{{date("Y-m-d",strtotime($ausencia->fechaInicio))}}" />
                    </div>
                </div>
                <div class="col-3">
                    <div class="form-group hasText">
                        <label for="fechaAusenciaFinal" class="control-label">Fecha Final:</label>
                        <input type="date" class="form-control" id="fechaAusenciaFinal" readonly name="fechaAusenciaFinal" value="{{date("Y-m-d",strtotime($ausencia->fechaFin))}}"/>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-3">
                    <div class="form-group hasText">
                        ...
                        <input type="text" id="domingoAplica" value=" @if ($ausencia->domingoAplica == "1") SI @endif @if ($ausencia->domingoAplica == "2") NO @endif" readonly/>
                    </div>
                </div>
            </div>
