<form action="/empresa/editarEmpresa" class="formEdit" method = "POST">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="SoftwareDianId" name = "SoftwareDianId" value="{{ $empresa->SoftwareDianId }}">
    </div>
    <div class="form-group">
        <label for="SoftwareTestSetId">Software Test Set Id nómina electrónica</label>
        <input type="text" class="form-control" id="SoftwareTestSetId" name = "SoftwareTestSetId" value="{{ $empresa->SoftwareTestSetId }}">
    </div>
    <div class="form-group">
        <label for="PrefijoNominaElectronica">Prefijo nómina electrónica</label>
        <input type="text" class="form-control" id="PrefijoNominaElectronica" name = "PrefijoNominaElectronica" value="{{ $empresa->PrefijoNominaElectronica }}">
    </div>
    <div class="form-group">
        <label for="ConsecutivoNominaElectronica">Consecutivo nómina electrónica</label>
        <input type="number" class="form-control" id="ConsecutivoNominaElectronica" name = "ConsecutivoNominaElectronica" value="{{ $empresa->ConsecutivoNominaElectronica }}">
    </div>
    <div class="form-group">
        <label for="PrefijoNominaElectronicaReemplazo">Prefijo nómina electrónica reemplazo</label>
        <input type="text" class="form-control" id="PrefijoNominaElectronicaReemplazo" name = "PrefijoNominaElectronicaReemplazo" value="{{ $empresa->PrefijoNominaElectronicaReemplazo }}">
    </div>
    <div class="form-group">
        <label for="ConsecutivoNominaElectronicaReemplazo">Consecutivo nómina electrónica reemplazo</label>
        <input type="number" class="form-control" id="ConsecutivoNominaElectronicaReemplazo" name = "ConsecutivoNominaElectronicaReemplazo" value="{{ $empresa->ConsecutivoNominaElectronicaReemplazo }}">
    </div>

    <div class="form-group">
        <label for="PrefijoNominaElectronicaEliminacion">Prefijo nómina electrónica eliminacion</label>
        <input type="text" class="form-control" id="PrefijoNominaElectronicaEliminacion" name = "PrefijoNominaElectronicaEliminacion" value="{{ $empresa->PrefijoNominaElectronicaEliminacion }}">
    </div>
    <div class="form-group">
        <label for="ConsecutivoNominaElectronicaEliminacion">Consecutivo nómina electrónica eliminacion</label>
        <input type="number" class="form-control" id="ConsecutivoNominaElectronicaEliminacion" name = "ConsecutivoNominaElectronicaEliminacion" value="{{ $empresa->ConsecutivoNominaElectronicaEliminacion }}">
    </div>
