...
@section('title', 'Nómina reemplazo')
@section('menuLateral')
...
<div class="row">
    <div class="col-12">
        <h1 class="granAzul">Nómina reemplazo masivo</h1>
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="cajaGeneral">
            <form method="POST" id="formDocumentoSS" autocomplete="off" enctype="multipart/form-data" class="formGeneral" action="/reportes/nominaReemplazoMasivo">
                @csrf
                <div class="row">
                    <div class="col-3">
