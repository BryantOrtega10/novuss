...
@section('title', 'Descargar archivo nómina reemplazo')
@section('menuLateral')
...
<div class="row">
    <div class="col-12">
        <h1 class="granAzul">Descargar archivo nómina reemplazo</h1>
    </div>
</div>
<div class="row">
    <div class="col-12">
        <div class="cajaGeneral">
            <form method="POST" id="formDocumentoSS" autocomplete="off" class="formGeneral" action="/reportes/nominaReemplazo">
                @csrf
                <div class="row">
                    <div class="col-3">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            <label for="cune" class="control-label">Cune</label>
                            <input type="text" class="form-control" id="cune" name="cune" required/>
                        </div>
                    </div>
                    <div class="col-3">
