<form method="post" action="/concepto/getFormulaConceptoSS/llenar" id="formFormulaConceptoSS">
	<h2>Agregar formula para seguridad social a concepto</h2>
	@csrf
	<input type="hidden" id="numOperacionSS" name="numOperacionSS" value="1" />
	...
	<div class="respMasOperacionesSS"></div>
	<button class="btn btn-secondary" type="button" id="masOperacionesSS">Mas operaciones</button>
