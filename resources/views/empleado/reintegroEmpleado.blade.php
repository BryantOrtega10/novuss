...
@section('title', 'Reintegrar empleado')
@section('menuLateral')
...
@section('contenido')
<h1 class="ordenSuperior">Reintegrar empleado</h1>
<nav>
    <div class="navGeneral nav nav-tabs" id="nav-tab" role="tablist">
        ...
        <a class="nav-item nav-link @if($destino=="afil") active @endif disabled" id="nav-afiliaciones-tab" data-toggle="tab" href="#nav-afiliaciones" role="tab" aria-controls="nav-afiliaciones" aria-selected="@if($destino=="afil") true @else false @endif">Afiliaciones</a>
        <a class="nav-item nav-link @if($destino=="concFij") active @endif disabled" id="nav-conceptosFijos-tab" data-toggle="tab" href="#nav-conceptosFijos" role="tab" aria-controls="nav-conceptosFijos" aria-selected="@if($destino=="concFij") true @else false @endif">Conceptos Fijos</a>
    </div>
</nav>
<div class="tab-content" id="nav-tabContent">
    ...
    <div class="tabGeneral tab-pane fade @if ($destino=="infoLab") show active @endif" id="nav-infoLab" role="tabpanel" aria-labelledby="nav-infoLab-tab">
        @if(!isset($periodoActivo))
            <form class="formGeneral" id="formInfoEmpleado" method="POST" action="/empleado/modificarDatosInfoPersonalReintegro" >
                @csrf
                <input type="hidden" class = "idEmpleado" name="idEmpleado" value="{{$idEmpleado}}"/>
                ...
                <section>
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="contMasMenos">
                            <div class="mas masCentroCosto" data-num="0">+</div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="tabGeneral tab-pane fade @if ($destino=="concFij") show active @endif" id="nav-conceptosFijos" role="tabpanel" aria-labelledby="nav-conceptosFijos-tab">
        <form class="formGeneral" id="formConceptosFijos" method="POST" action="/empleado/conceptosFijosReintegro" >
            @csrf
                ...
                <div class="conceptosCont">
                    ...
                    @for($i = 1; $i<=sizeof($conceptosFijos); $i++)
                        <div class="conceptoFijo" data-id="{{$i}}">
                            ...
                            @endif                            
                            <div class="row @if ($i > 1) display-none @endif">
                                @if ($i > 1) <input type="hidden" name="conceptoPasado[]" value="{{$conceptosFijos[$i-1]->idConceptoFijo}}">  @endif
                                <div class="col-3">
                                    <div class="form-group hasText">
                                ...
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control separadorMiles" id="conFiValor{{$i}}" name="conFiValor[]" />
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label for="conFiPorcentaje{{$i}}" class="control-label">Porcentaje</label>
                                        <input type="text" class="form-control" id="conFiPorcentaje{{$i}}" name="conFiPorcentaje[]" @if ($i == 1) readonly @endif value="{{$conceptosFijos[$i-1]->porcentaje}}" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-3">
                                    <div class="form-group">
                                        ...
                                        <input type="date" class="form-control" id="conFiFechaInicio{{$i}}" name="conFiFechaInicio[]"  />
                                    </div>
                                </div>
                                <div class="col-3">
                                    <div class="form-group">
                                        <label for="conFiFechaFin{{$i}}" class="control-label">Fecha Fin</label>
                                        <input type="date" class="form-control" id="conFiFechaFin{{$i}}" name="conFiFechaFin[]" />
                                    </div>
                                </div>
                            </div>
                            @if ($i == 1)
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="conFiPorcentaje1" name="conFiPorcentaje[]" readonly />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <input type="date" class="form-control" id="conFiFechaInicio1" name="conFiFechaInicio[]"  />
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <div class="form-group">
...
<script type="text/javascript" src="{{ URL::asset('js/empleado/reintegro/empleado.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('js/empleado/reintegro/datosEmpleado.js') }}"></script>
@isset($empleado->fkEmpresa)
    <script type="text/javascript" src="{{ URL::asset('js/empleado/reintegro/infoLabEmpleadoMod.js') }}"></script>
@else
    <script type="text/javascript" src="{{ URL::asset('js/empleado/reintegro/infoLabEmpleado.js') }}"></script>
@endisset
<script type="text/javascript" src="{{ URL::asset('js/empleado/reintegro/afiliacionEmpleado.js') }}"></script>
<script type="text/javascript" src="{{ URL::asset('js/empleado/reintegro/conceptosFijosEmpleado.js') }}"></script>
