...
$(document).ready(function() {
    ...
    var camposOpciones = {
        ...
        opcionales: ["telFijo", "tallaCamisa", "tallaPantalon", "tallaZapatos", "otros", "tallaOtros", "correo2", "inputFoto"],
        opcionalesAVeces: [{
                camposQueSonOb: ["libretaMilitar", "distritoMilitar"],
                camposCambia: [{ campo: "genero", valorCambia: ["2"] }],
                tipoBloqueo: 1
            },
            {
    ...
    $("body").on("submit", "#formAgregarEmpleado", function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (data.success) {
                    window.open("/empleado/formModificar/" + data.idempleado, "_self");
                } else {
