...
$(document).ready(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if ($.isEmptyObject(data.error)) {
                    if (data.success) {
                        alert("Novedad modificada exitosamente");
                        window.open(data.ruta, "_self");
                    }
                } else {
    ...
    function cambiarFechaFinalConCalendario() {
        ...
        $.ajax({
            type: 'GET',
            url: '/novedades/fechaConCalendario/?fecha=' + $("#fechaInicialVaca").val() + "&dias=" + $("#diasVaca").val() + "&idEmpleado=" + $("#idEmpleado").val() + "&idPeriodo=" + $("#idPeriodo").val(),
            cache: false,
            success: function(data) {
                $("#cargando").css("display", "none");
                if (data.success) {
