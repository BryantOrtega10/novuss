$(document).ready(function() {
    ...
    var camposOpciones = {
        ...
        opcionalesAVeces: [{
            ...
            },
            {
                ...
                camposCambia: [{ campo: "infoTipoContrato", valorCambia: ["2", "4"] }],
                tipoBloqueo: 1
            },
            {
                camposQueSonOb: ["infoFechaFinN", "infoTipoDuracionContratoN", "infoDuracionContratoN"],
                camposCambia: [{ campo: "infoTipoContratoN", valorCambia: ["2", "4"] }],
                tipoBloqueo: 1
            },
            {
            ...
            {
                camposQueSonOb: ["infoPersonaVive?", "infoTIdentificacion?", "infoNumIdentificacion?", "infoValorTotal?", "infoNumMeses?", "infoValorMensual?"],
                camposCambia: [{ campo: "infoTipoBeneficio?", valorCambia: ["1", "2", "3", "5", "4"] }],
                tipoBloqueo: 3
            },
            {
    ...
    $("body").on("submit", "#formInfoEmpleado", function(e) {
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data.success) {
                    window.open("/empleado/formModificar/" + data.idempleado + "/" + data.idPeriodo + "?destino=afil", "_self");
                } else {
                    $(".separadorMiles").inputmask({ alias: "currency", removeMaskOnSubmit: true });
    ...
    $("body").on("change", ".infoTipoBeneficio", function(e) {
        ...
        $(".infoBeneficioSinPersona[data-id='" + dataid + "']").addClass("activo");

        if ($(this).val() == "4") {
            $(".infoBeneficioSinPersona[data-id='" + dataid + "']").removeClass("activo");
    ...
    $("body").on("click", ".generar_pass", function(e) {
        ...
        solicitudAjax(`/empleado/dataEmpContrasenia/${idUsu}`, 'GET', null,
            (data) => {
                if (data.success) {
...
function getRandomWord() {
    const things = ['trabajo', 'nomina', 'empresa'];
