...
$(document).ready(function() {
    ...
    $("body").on("click", ".resFormBusEmpleado a.seleccionarEmpleado", function(e) {
        ...
        cargarnominasxEmpleado($("#idEmpleado").val(), $("#idPeriodo").val());
    });

    function cargarnominasxEmpleado(idEmpleado, idPeriodo) {
        cargando();
        $("#idBoucherPago").html('<option value=""></option>');
        $.ajax({
            type: 'GET',
            url: '/reportes/liquidacionesxEmpleado/' + idEmpleado + "/" + idPeriodo,
            success: function(data) {
                $("#cargando").css("display", "none");
